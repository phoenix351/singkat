...
export function useLayout() {
    ...
    const isPrimary = localStorage.getItem('primary-color');
    const isSurface = localStorage.getItem('surface-color');
    if (isPrimary !== null) {
        layoutConfig.primary = isPrimary;
        updatePreset(getPresetExt());
    }
    if (isSurface !== null) {
        layoutConfig.surface = isSurface;
        const color = surfaces.find((c) => c.name === isSurface)
