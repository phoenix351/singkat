  ...
  <AppLayout>
    ...
    >
      <div class="flex flex-col gap-6">
        ...
        <template v-if="form.tipe == 'manual' || isUpdated">
          <div>
        ...
        <template v-if="form.tipe == 'upload' && !isUpdated">
  ...
  try {
    ...
    if (!isUpdated.value) {
      ...
      if (fileupload) {
        ...
        router.post(
          route("man-management.role-management.store"),
          {
            _token: tokens,
...
const downloadTemplate = () => {
  window.location.href = "/man-management/download-template/role";
};
</script>
