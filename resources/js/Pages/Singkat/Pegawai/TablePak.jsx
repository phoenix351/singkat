                ...
                <table className="w-full table-auto">
                    <thead>
                        <tr className="bg-gray-2 text-left dark:bg-meta-4">
                            ...
                            <th
                                colSpan={3}
                                className="min-w-[120px] py-4 px-4 font-medium text-black text-center dark:text-white"
                            >
                                Angka Kredit
                            </th>
                    ...
                    <tbody>
                        {pegawai.data.length > 0 ? (
                            ...
                            <tr>
                                ...
                                >
                                    <Empty
                                        description={"Data Pegawai Belum Ada"}
                                    />
                                </td>
                            </tr>
                        )}
